...
namespace Arseni_Teodora_Madalina_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Arseni_Teodora_Madalina_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Arseni_Teodora_Madalina_Lab8Context context,
